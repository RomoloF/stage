...
public class Converto {
	public static void main(String[] args) throws IOException, TransformerException
	{
	    ...
	    String resultFile = "/home/romolofiorenza/stage/it.pdf/src/main/java/it/pdf/pdf/ucm_086092PDFA.pdf";  
	    FileInputStream in = new FileInputStream("/home/romolofiorenza/stage/it.pdf/src/main/java/it/pdf/pdf/ucm_086092.pdf");
	    ...
	    try 
	    {
	      ...
	      */ 
	        ...
	        // sRGB output intent
	        InputStream colorProfile = Converto.class.getResourceAsStream(
	                "sRGB2014.icc");
	      ...
	      //  throw new IllegalArgumentException(e);
	    	System.out.println("Errore alla riga 142");
	    }
	}
}
