 ...
 */
public class PdfAConverter2 {

    /**
     * Metodo per convertire un PDF in PDF/A.
     *
    ...
    public static void convertToPdfA() throws IOException {
        String inputPath = "/home/romolofiorenza/stage/it.pdf/src/main/java/it/pdf/pdf/Allegato 1 - modello_dichiarazione_accessibilità_privati.pdf";
        String outputPath = "/home/romolofiorenza/stage/it.pdf/src/main/java/it/pdf/pdf/Allegato 1 - modello_dichiarazione_accessibilità_privatiPDFA.pdf";
        ...
        try {
         ...
         // Aggiungi il profilo colore
            try (InputStream colorProfile = PdfAConverter2.class.getResourceAsStream("sRGB2014.icc")) {
            	System.out.println("Sono entrato "+colorProfile);
    ...
    public static void main(String[] args) {
 	   System.out.println("Converte PDF in PDF/A ...");
